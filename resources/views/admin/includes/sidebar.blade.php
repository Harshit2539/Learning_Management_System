<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand" style="border-bottom: 1px solid lightgray;padding: 20px 0px; height:80px !important; line-height:80px !important;">
