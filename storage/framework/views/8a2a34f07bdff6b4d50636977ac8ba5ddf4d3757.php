                ...
                <div class="col-12 col-lg-6">
                    <div class="d-flex align-items-start">
                        ...
                        <div class="ml-10">
                            ...
                            <p class="d-block font-14 text-gray mt-10 white-space-pre-wrap"><?php echo e($forum->description); ?></p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-6 mt-15 mt-lg-0 border-left">
                    ...
                    <?php if(!empty($forum->answers) and count($forum->answers)): ?>
                        ...
                        <div class="py-15 border-top position-relative">
                            <span class="d-block font-12 text-gray text-left"><?php echo e(trans('update.last_answer')); ?></span>
...
<?php /**PATH /var/www/lms-laravel/resources/views/web/default/course/learningPage/components/forum/forum.blade.php ENDPATH**/ ?>