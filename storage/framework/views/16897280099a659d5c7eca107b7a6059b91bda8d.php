            ...
            <form action="<?php echo e(getAdminPanelUrl()); ?>/settings/main" method="post">
                ...
                <div class="form-group mt-3 custom-switches-stacked">
                    <label class="custom-switch pl-0">
                        ...
                        <label class="custom-switch-description mb-0 cursor-pointer" for="contentTranslate"><?php echo e(trans('update.enable_multi_currency')); ?></label>
                    </label>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/lms-laravel/resources/views/admin/settings/financial/currency.blade.php ENDPATH**/ ?>